...
<head>
    ...
    <title>Sinme-SAC - Materiales Sanitarios</title>
            ...
            <section class="products-section" aria-labelledby="products-heading">
                <div class="section-header">
                    ...
                    <div class="search-filter">
                        <input type="text" id="productSearch" placeholder="Buscar Materiales..."
                            aria-label="Buscar Materiales">
                        <select id="productFilter" aria-label="Filtrar Materiales">
                ...
                <div class="products-grid" role="grid" aria-label="Lista de Materiales">
                    <?php
        ...
        <div class="modal-content">
            ...
            <form id="productForm" action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="productName">Nombre del productos</label>
                ...
                <div class="form-group">
                    ...
                    <select id="productCategory" name="productCategory" required>
                        <?php
                        $query = "SELECT CategoriaID, Nombre FROM categorias WHERE Nombre = 'Materiales Sanitarios' LIMIT 1";
                        $result = $conn->query($query);
                        ...
                        if ($result && $result->num_rows > 0) {
                            ...
                            echo "<option value=''>Categoría 'Materiales Sanitarios' no encontrada</option>";
                        }
                        ?>
                    </select>
                </div>
